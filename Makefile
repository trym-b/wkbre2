srcRoot = wkbre2.o file.o tags.o test.o server.o client.o window.o imguiimpl.o terrain.o TrnTextureDb.o mesh.o network.o netenetlink.o anim.o Camera.o Model.o scene.o TimeManager.o Order.o Movement.o NNSearch.o settings.o Language.o Trajectory.o SoundPlayer.o WavDocument.o MovementController.o ParticleSystem.o ParticleContainer.o platform.o AIController.o common.o
srcGameset = gameset/gameset.o gameset/GameObjBlueprint.o gameset/values.o gameset/actions.o gameset/finder.o gameset/command.o gameset/OrderBlueprint.o gameset/position.o gameset/reaction.o gameset/ObjectCreation.o gameset/ScriptContext.o gameset/condition.o gameset/GameTextWindow.o gameset/Package.o gameset/3DClip.o gameset/cameraPath.o gameset/Sound.o gameset/Footprint.o gameset/GSTerrain.o gameset/Plan.o gameset/ArmyCreationSchedule.o gameset/WorkOrder.o
